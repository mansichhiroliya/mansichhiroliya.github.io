...
(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        settingDOM : function (){
            var _this_  = this ,
                btnHTML = (this.options.switching === "normal") ? "<div class='dnSlide-btn dnSlide-left-btn'></div><div class='dnSlide-btn dnSlide-right-btn'></div>" :"<div class='dnSlide-btn dnSlide-left-btn'></div><div class='dnSlide-btn dnSlide-right-btn'></div>";
            ...
            jQuery.each(this.resourceSrcArr , function(i,e){
                counts++;
                ulDOM.append('<li class="dnSlide-item"><a href="javascript:void(0)"><img class="slide-img item'+counts+'" src="'+_this_.resourceSrcArr[i]+'" width="100%"></a></li>');
            });
